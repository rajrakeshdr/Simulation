...
ECHO -------------------------------------------------------------------
cmd /c sc.exe create TestService1 binPath= "C:\windows\system32\WindowsPowerShell\v1.0\powershell.exe -noexit -c \"write-host 'T1050 - Service Creation via CMD'\""
...
ECHO -------------------------------------------------------------------
Powershell New-Service -Name "TestService2" -BinaryPathName "C:\windows\system32\WindowsPowerShell\v1.0\powershell.exe -noexit -c \"write-host 'T1050 - Service Creation via Powershell'\""
